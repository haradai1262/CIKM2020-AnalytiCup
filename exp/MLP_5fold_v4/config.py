...
EPOCH_NUM = 12
BATCH_SIZE = 512
DNN_HIDDEN_UNITS = (2048, 512, 128)  # (2048, 512, 128)  # (4096, 1024, 128)
DNN_DROPOUT = 0.1
DNN_ACTIVATION = 'relu'
L2_REG = 1e-4
INIT_STD = 1e-4

SPAESE_EMBEDDING_DIM = 32
...
social_stats_features = [
    '#followers', '#friends', '#favorites',
    '#followers__#favorites', '#friends__#favorites', '#followers__#friends__#favorites',
]
social_stats_log_features = [f'{feat}_log' for feat in social_stats_features]
social_stats_cdf_features = [f'{feat}_cdf' for feat in social_stats_features]
social_stats_z_features = [f'{feat}_z' for feat in social_stats_features]
social_stats_rank_features = [f'{feat}_rank' for feat in social_stats_features]
...
nbin = 10
social_stats_bin_features = [f'{feat}_qbin_{nbin}' for feat in social_stats_features]
...
################################################################
dense_features = []
dense_features += social_stats_features
dense_features += social_stats_log_features
dense_features += social_stats_cdf_features
dense_features += social_stats_z_features
dense_features += social_stats_rank_features
...
sparse_features += social_stats_bin_features
